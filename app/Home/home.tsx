    ...
    <View style={styles.container}>
      ...
      <View style={styles.exploreContainer}>
        ...
        <View style={styles.row}>
          <Image source={require("../../assets/home-image/imagem-1.png")} style={styles.exploreImage1} />
          <TouchableOpacity onPress={() => router.push("/Menu-Diario/menu-diario")}>
          <Image
            source={require("../../assets/home-image/imagem-2.png")}
        ...
        <View style={styles.row}>
          <Image source={require("../../assets/home-image/imagem-3.png")} style={styles.exploreImage3} />
          <TouchableOpacity onPress={()=> router.push("/Grafico/grafico")}>
          <Image source={require("../../assets/home-image/imagem-4.png")} style={styles.exploreImage4} />
          </TouchableOpacity>
